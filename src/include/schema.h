...
typedef struct {
  ...
  int first_child;            //
  int pattern_props_head;     // Object: schema
  int additional_schema_head; // Object: Schema for additional properties
